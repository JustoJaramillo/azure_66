    ...
    public class TestFactory
    {
        public static TodoEntity GetTodoEntity() {
            return new TodoEntity
            {
                ...
                IsCompleted=false,
                TaskDescription = "Task: Kill the humans being"
            };
        }
        ...
        public static Todo GetTodoRequest()
        {
            return new Todo
            {
                CreatedTime = DateTime.UtcNow,
                IsCompleted=false,
                TaskDescription= "Trying to conquer the world"
            };
        }

        public static Stream GenerateStreamFromString(string strinToConvert)
        {
